...
RSpec.describe Recipe, type: :model do
  ...
  it 'is valid' do
    recipe = Recipe.new(name: 'Miso Paste', preparation_time: '120', cooking_time: '210',
                        description: 'Test', public: false, user_id: @user.id)
    expect(recipe).to be_valid
  end

  it 'should not be valid without a name' do
    recipe = Recipe.new(name: nil, preparation_time: '145', cooking_time: '154', description: 'Test',
